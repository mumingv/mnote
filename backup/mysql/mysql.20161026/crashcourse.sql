...
--
-- Table structure for table `custnew`
--
...
--
-- Dumping data for table `custnew`
--

LOCK TABLES `custnew` WRITE;
/*!40000 ALTER TABLE `custnew` DISABLE KEYS */;
INSERT INTO `custnew` VALUES (1,'Zihang Yin','100 Main Street','Los Angeles','CA','90046','USA',NULL,NULL);
/*!40000 ALTER TABLE `custnew` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `customers` VALUES (10001,'Coyote Inc.','200 Maple Lane','Detroit','MI','44444','USA','Y Lee','ylee@coyote.com'),(10002,'Mouse House','333 Fromage Lane','Columbus','OH','43333','USA','Jerry Mouse',NULL),(10003,'Wascals','1 Sunny Place','Muncie','IN','42222','USA','Jim Jones','rabbit@wascally.com'),(10004,'Yosemite Place','829 Riverside Drive','Phoenix','AZ','88888','USA','Y Sam','sam@yosemite.com'),(10005,'E Fudd','4545 53rd Street','Chicago','IL','54545','USA','E Fudd','elmer@fudd.com'),(10006,'Pep E. LaPew','100 Main Street','Los Angeles','CA','90046','USA',NULL,'elmer@fudd.com'),(10007,'Pep E. LaPew','100 Main Street','Los Angeles','CA','90046','USA',NULL,'elmer@fudd.com'),(10008,'Pep E. LaPew','100 Main Street','Los Angeles','CA','90046','USA',NULL,'elmer@fudd.com'),(10009,'Pep E. LaPew','100 Main Street','Los Angeles','CA','90046','USA',NULL,'elmer@fudd.com'),(10010,'Pep E. LaPew','100 Main Street','Los Angeles','CA','90046','USA',NULL,'elmer@fudd.com'),(10011,'Jay Yin','100 Main Street','Los Angeles','CA','90046','USA',NULL,'elmer@fudd.com');
...
INSERT INTO `products` VALUES ('ANV01',1001,'.5 ton anvil',5.99,'.5 ton anvil, black, complete with handy hook'),('ANV02',1001,'1 ton anvil',9.99,'1 ton anvil, black, complete with handy hook and carrying case'),('ANV03',1001,'2 ton anvil',14.99,'2 ton anvil, black, complete with handy hook and carrying case'),('DTNTR',1003,'Detonator',13.00,'Detonator (plunger powered), fuses not included'),('FB',1003,'Bird seed',10.00,'Large bag (suitable for road runners)'),('FC',1003,'Carrots',2.50,'Carrots (rabbit hunting season only)'),('FU1',1002,'Fuses',3.42,'1 dozen, extra long'),('JP1000',1005,'JetPack 1000',35.00,'JetPack 1000, intended for single use'),('JP2000',1005,'JetPack 2000',55.00,'JetPack 2000, multi-use'),('OL1',1002,'Oil can',8.99,'Oil can, red'),('SAFE',1003,'Safe',50.00,'Safe with combination lock'),('SLING',1003,'Sling',4.49,'Sling, one size fits all'),('TEST',1003,'TEST',9.90,'TEST'),('TNT1',1003,'TNT (1 stick)',2.50,'TNT, red, single stick'),('TNT2',1003,'TNT (5 sticks)',10.00,'TNT, red, pack of 10 sticks');
/*!40000 ALTER TABLE `products` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `vendorlocatoins`
--

DROP TABLE IF EXISTS `vendorlocatoins`;
/*!50001 DROP VIEW IF EXISTS `vendorlocatoins`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vendorlocatoins` AS SELECT 
 1 AS `vend_title`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `vendorlocatoins`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vendorlocatoins` AS select concat(rtrim(`vendors`.`vend_name`),'(',rtrim(`vendors`.`vend_country`),')') AS `vend_title` from `vendors` order by `vendors`.`vend_name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2016-10-26 15:41:00
